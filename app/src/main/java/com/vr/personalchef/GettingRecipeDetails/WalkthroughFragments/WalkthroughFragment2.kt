...
import com.vr.personalchef.GettingRecipeDetails.RecipeDetailActivitys.CaptureDishPhotoActivity
...
class WalkthroughFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnFinish.setOnClickListener {
            val i = Intent(activity,CaptureDishPhotoActivity::class.java)
            startActivity(i)
        }
